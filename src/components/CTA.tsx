  ...
  return (
    <section id="demo" className="relative overflow-hidden border-t border-white/[0.06] px-6 py-24 sm:py-32">
      ...
      >
        ...
        <h2 className="text-display text-center text-[clamp(2.5rem,6vw,5rem)] text-white">
          Parler à
          <br />
          <span className="text-accent-light">l&apos;équipe produit.</span>
        </h2>

        <p className="mx-auto mt-8 max-w-[520px] text-center text-[15px] leading-[1.75] text-white/35">
          Démo technique, atelier MQTT ou simple échange sur votre périmètre —
          on s&apos;adapte à votre contexte.
        </p>

        <div className="mt-12 flex flex-col items-center justify-center gap-4 sm:flex-row">
          <a href="mailto:contact@fawd.be?subject=Démo Arcos" className="btn-primary">
            Écrire à l&apos;équipe
            <ArrowRight className="h-4 w-4" />
          </a>
          <a href="mailto:contact@fawd.be?subject=Atelier technique Arcos" className="btn-ghost">
            Atelier technique
          </a>
        </div>

        <p className="mt-14 text-center text-data text-[11px] text-white/18">
